...
class Foodcheri {
    constructor(config) {
        this.request = axios.create({
            baseURL: 'https://www-preprod.foodcheri.com/api/v1',
            headers: {
                'x-fc-api-key': config.apiKey,
                'x-fc-platform': 'android',
                'x-fc-version': '2.5.3_253',
                'Authorization': 'Token eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZF91c2VyIjoxLCJlbWFpbCI6ImFkbWluQGZvb2RjaGVyaS5jb20iLCJleHAiOiIxNjAyMTc2OTQ2In0.DK7fcKx-xgDH1wvH84FAWiSj4jW09Je4x8xsx5UigcM'
            }
        });
    }
    ...
    async signUp({phone, last_name, email, first_name, password}) {
        try {
